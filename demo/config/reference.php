 ...
 * }
 * @psalm-type ChrisDevUxComponentsConfig = array{
 *     navbar?: array{
 *         brand?: array{
 *             label?: scalar|Param|null, // Default: "Symfony Ux Starter Kit"
 *             route?: scalar|Param|null, // Default: "app_home"
 *             logo?: scalar|Param|null, // Default: "bi:boxes"
 *         },
 *         items?: list<array{ // Default: [{"label":"Accueil","route":"app_home","icon":"bi:house","authenticated":false},{"label":"Compte","route":"app_account","icon":"bi:person","authenticated":true}]
 *             label?: scalar|Param|null,
 *             route?: scalar|Param|null,
 *             icon?: scalar|Param|null,
 *             authenticated?: bool|Param, // Default: false
 *         }>,
 *         user_items?: array{
 *             logged_in?: array{
 ...
 *     chris_dev_ux_components?: ChrisDevUxComponentsConfig,
